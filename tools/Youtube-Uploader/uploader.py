        ...
        try:
            ...
            if not creds.refresh_token:
                ...
                should_refresh = (
                    ...
                    time_to_expiry.total_seconds() <= FORCE_TOKEN_REFRESH_DAYS * 24 * 60 * 60  # Refresh if within refresh window
...
def initialize_upload_simple(youtube, videofile, title, description, playlistId):
