"""
    old script found in the log folder
"""
...
def find_game_logs(candidates, dest, game):
    ...
    if os.path.exists(cs[0] + '/half1_timeout'):
        rename_and_move(cs[0] + '/half1_timeout', dest + '/' + game_folder[0] + '_to1/game_logs')
    if os.path.exists(cs[0] + '/half2_timeout'):
        rename_and_move(cs[0] + '/half2_timeout', dest + '/' + game_folder[1] + '_to2/game_logs')
